    ...
    education: [
      {
        ...
        where: "NEOLAND",
        description:
          "Curso intensivo de desarrollo web en el que adquirí conocimientos de Backend y Frontend, sobre los lenguajes Javascript, HTML y CSS, y tecnologías como React, Node.js, MongoDB, Styled Components, Vite, GitHub, Axios,... "
      },
      {
      ...
      },
      {
        ...
        description:
        "Alumna interna durante 2 años, desarrollando un proyecto de Química Computacional sobre el que más tarde basé mi TFG"
      },
    ],
    experience: [
      {
        name: "Química en laboratorio cromatográfico",
        date: "nov 2019 - nov 2023",
        where: "Iberchem",
        description:
          "Análisis químico, cromatografía de gases, control de calidad. SAP, AMDIS y Agilent Data Analysis.",
      },
      {
        name: "Freelance",
        ...
        where: "",
        description:
          "Desde el inicio del Bootcamp de Web Development, he desarrollado diversos proyectos tanto por mi cuenta como en equipo con el resto de alumnos del curso.",
      }
    ],
    projects: [
      {
